...
export default function RenderDashBoard() {
  ...
  return (
    ...
    >
      <div
        className={`w-[14.8125rem] ${!height ?"h-full":'h-[45rem] '} bg-primary flex flex-col justify-start items-center rounded-t-3xl  absolute ${!height ? "top-20" : "bottom-0"}`}
      >
        <ul className="flex flex-col justify-center items-start  ">
          ...
          <li className={`text-white text-[1.5rem] my-4 hover:underline hover:font-extrabold   absolute ${height? "bottom-5": "bottom-20"} left-[40%] right-[50%]`}>
            Sair
          </li>
        </ul>
      </div>
